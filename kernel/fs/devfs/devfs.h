...
typedef struct DEVFS_DeviceOps {
   uint32_t (*read)(DEVFS_DeviceNode *node, uint32_t offset, uint32_t size, void *buffer);
   uint32_t (*write)(DEVFS_DeviceNode *node, uint32_t offset, uint32_t size, const void *buffer);
